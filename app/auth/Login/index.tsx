  ...
  return (
    <View style={styles.container}>
        ...
        <View className='flex flex-col space-y-4'>
            ...
            <TextInput className='p-3 px-4 bg-white rounded-md' />
            <Button textStyle='text-white font-normal' title='Forgot password?' onPress={() => router.push("/auth/ForgotPassword")} buttonStyle='py-0 w-full items-end bg-transparent' /> 
        </View>
        <Button title='Login' onPress={() => router.push("/dashboard/Home")} buttonStyle='bg-secondary mt-6 w-full' />
        <View className='flex flex-col items-center mt-12 space-y-7'>
          ...
          <Button textStyle='text-white/80 font-normal' title='' onPress={() => router.push("/auth/Register")} buttonStyle='bg-transparent flex-row space-x-2 p-0 py-0'>
